/*	Simplex : $\color{commentcolor}n$ varibles, $\color{commentcolor}m$ constraints, maximize $\color{commentcolor}\sum c_jx_j$ with constraint $\color{commentcolor}\sum a_{ij}x_j\le b_i$.
The solution is in an[]. */
...
struct simplex {
	...
	double solve () {
		...
		return v; } };
/*	maximize $\color{commentcolor}\bf c^Tx$, subject to $\color{commentcolor}\bf Ax\leq b, \bf x\geq 0$ <=>
	minimize $\color{commentcolor}\bf b^Ty$, subject to $\color{commentcolor}\bf A^Tx\geq c, \bf y\geq 0$ */
