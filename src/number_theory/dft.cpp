/*	Discrete Fourier transform : the nafarious you-know-what thing. 
Usage : call init for the suggested array size, and solve for the transform. (use f!=0 for the inverse) */
