/*	Linear recurrence : finds the n-th element of a linear recurrence.
Usage : vector <int> - first n terms, vector <int> - transition function, calc (k) : the kth term mod MOD.
Example : In : {2, 1}, {2, 1} : $\color{commentcolor}a_1=2,a_2=1,a_n=2a_{n-1}+a_{n-2}$, Out : calc (3) = 5, calc (10007) = 959155122 (MOD 1E9+7) */
struct linear_rec {
