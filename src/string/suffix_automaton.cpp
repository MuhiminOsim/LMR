/*	Suffix automaton : head - the first state. tail - the last state. Terminating states can be reached via visiting the ancestors of tail. state::len - the longest length of the string in the state. state::right - 1 - the first location in the string where the state can be reached. state::parent - the parent link. state::dest - the automaton link. */
