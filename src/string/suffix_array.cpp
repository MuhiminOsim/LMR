/*	Suffix Array : sa[i] - the beginning position of the ith smallest suffix, rk[i] - the rank of the suffix beginning at position i. height[i] - the longest common prefix of sa[i] and sa[i - 1]. */
