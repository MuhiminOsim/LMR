/*	Palindromic tree : extend () - returns whether the tree has generated a new node. odd, even - the root of two trees. last - the node representing the last char. node::len - the palindromic string length of the node. */
