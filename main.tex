...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\section{Formula}
			...
			\subsection{Simplex}
				\lstinputlisting{src/formula/simplex.cpp}
			\subsection{Extended Eratosthenes sieve}
				\lstinputlisting{src/formula/ees.cpp}
		...
		\section{Geometry}
			...
			\subsection{Delaunay triangulation}
				\lstinputlisting{src/geometry/delaunay.cpp}
			\subsection{3D point}
		...
		\section{String}
			\subsection{Minimum representation}
				\lstinputlisting{src/string/minimum_representation.cpp}
			\subsection{Manacher}
		...
		\section{Tips}
			...
			\subsection{Formatting}
				\lstinputlisting{src/tips/format.cpp}
			\subsection{Fast IO}
				\lstinputlisting{src/tips/fast_io.cpp}
			...
			\subsection{Lyndon word}
				\input{tex/lyndon.tex}
			\subsection{Delaunay triangulation}
				\input{tex/delaunay.tex}
			\subsection{Euler characteristic}
				\input{tex/euler_char.tex}
		\section{Appendix}
			\subsection{Table of derivatives \& integrals}
